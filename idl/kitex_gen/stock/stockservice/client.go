...
func (p *kStockServiceClient) PreDeductStock(ctx context.Context, req *stock.StockReq, callOptions ...callopt.Option) (r *stock.StockResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.PreDeductStock(ctx, req)
}
